 ...
 */
public class AlzzzzPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link AlzzzzPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link AlzzzzPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(AlzzzzPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link AlzzzzPlayer#onRenderers} or
     * {@link AlzzzzPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
  ...
  public AlzzzzPlayer(RendererBuilder rendererBuilder) {
   ...
   *
   * @param renderers Renderers indexed by {@link AlzzzzPlayer} TYPE_* constants. An individual

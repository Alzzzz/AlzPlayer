 ...
 */
public class EventLogger implements AlzzzzPlayer.Listener, AlzzzzPlayer.InfoListener,
    AlzzzzPlayer.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[AlzzzzPlayer.RENDERER_COUNT];
  }
